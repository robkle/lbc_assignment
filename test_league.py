...
class TestLeague(unittest.TestCase):
	...
	def test_init(self):
		...
		with self.assertRaises(TypeError):
			...
			verror5 = league.LeagueTable({'Bob', 'Joe', 'Jim'})
	...
	def test_get_score(self):
		...
		self.assertIsNone(self.table1.get_scores('Max'))
		self.assertIsNone(self.table1.get_scores(23))
		self.assertIsNone(self.table2.get_scores('Bob'))
	...
	def test_get_rank(self):
		...
		self.assertIsNone(self.table2.get_player_by_rank(1))	
		self.populate()
		...
		self.assertIsNone(self.table1.get_player_by_rank(4))	
		self.assertIsNone(self.table1.get_player_by_rank(0))	
		self.assertIsNone(self.table1.get_player_by_rank(-1))
		self.assertIsNone(self.table1.get_player_by_rank('x'))
