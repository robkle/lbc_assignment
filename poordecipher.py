...
encrp = poorcipher("Hello world")
print(encrp.decode(), end='')
decrp = poordecipher("S2Bjf2dmYXwvZ255ai9uL2hgYGsvfGphfGovYGkvZ3piYH0h")
print(decrp)
#returns 'Dolphins have a good sense of humor.'
